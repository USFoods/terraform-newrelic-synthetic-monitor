run "policy_configuration" {
  ...
  assert {
    condition     = output.policy_name == "Simple Monitor Condition Policy"
...
run "monitor_configuration" {
  ...
  assert {
    condition     = output.main.name == "Simple Monitor Condition"
...
run "condition_configuration" {
  ...
  assert {
    condition     = output.main.condition_name == "Simple Monitor Condition"
