# Simple Monitor Condition

Configuration in this directory creates a new synthetic simple monitor configured to run in a public location along with an alert condition targeting the monitor.
